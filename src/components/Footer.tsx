const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-4 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          {/* Facebook */}
          <a
            href="https://facebook.com/edwin.nicaragua"
            target="_blank"
          ...
          {/* Instagram */}
          <a
            href="https://instagram.com/edwin.nicaragua"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* Email */}
          <a
            href="mailto:edwin.nicaragua@email.com"
        ...
        <div className="text-center md:text-right">
          <p className="text-xs text-gray-400">
            © 2024 Cafetín Ali - Todos los derechos reservados
          </p>
